...
|---|---|---|---|---|
| B1 | **Dataset access** — GraSP, MultiBypass140, Cholec80/CholecT50, HeiChole | USER | 2026-09-06 | GraSP = direct download (github.com/BCV-Uniandes/GraSP). Cholec80 + CholecT50 + MultiBypass140 = CAMMA forms (camma.unistra.fr/datasets + each repo README). HeiChole = Synapse `syn18824884` + data-use agreement (OOD-only). Turnaround days. **P1 decode is blocked on these; P0 and P2/P3-on-stand-in are not.** |
